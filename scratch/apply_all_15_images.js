...
const imageMapping = [
  ...
  // BATCH 3 (NEW 5)
  {
    src: 'media_1789840573849.jpg',
    destName: 'heritage-refined-mens.jpg',
    url: '/images/products/heritage-refined-mens.jpg',
    id: 'prd_28',
  ...
  {
    src: 'media_1789840573935.jpg',
    destName: 'tangerine-palazzo-set.jpg',
    url: '/images/products/tangerine-palazzo-set.jpg',
    id: 'prd_09',
  ...
  {
    src: 'media_1789840573970.jpg',
    destName: 'black-tuxedo-detail.jpg',
    url: '/images/products/black-tuxedo-detail.jpg',
    id: 'prd_29_detail',
    slug: 'black-tuxedo-detail',
  ...
  {
    src: 'media_1789840574023.jpg',
    destName: 'black-tuxedo-suit.jpg',
    url: '/images/products/black-tuxedo-suit.jpg',
    id: 'prd_29',
    ...
    mrp: 4699900,
    discount_percent: 12,
    extraImages: ['/images/products/black-tuxedo-detail.jpg'],
  },
  {
    src: 'media_1789840574034.jpg',
    destName: 'timeless-mauve-bandhgala.jpg',
    url: '/images/products/timeless-mauve-bandhgala.jpg',
    id: 'prd_30',
...
async function main() {
  ...
  console.log('Updating database products with all custom uploaded photos...');
  for (const item of imageMapping) {
    if (item.isAuxiliary) continue;

    const imgArr = [item.url, ...(item.extraImages || [])];
  ...
  console.log('Database updated with all custom uploaded photos!');
  await pool.end();
}
